...
// Fictional-but-realistic seed data for the mock-data phase. Fixed ISO dates
// (no Date.now()) so tests and snapshots stay stable.
// TODO: connect to API — replaced by the seeded backend catalogue.
...
export const MOCK_GROUPS: SupportGroup[] = [
  {
    ...
    color: DISEASE_COLORS['Breast Cancer'],
    member_count: 214,
  },
  {
    id: 'g-t2d',
    ...
    color: DISEASE_COLORS['Type 2 Diabetes'],
    member_count: 389,
  },
  {
    id: 'g-ra',
    ...
    color: DISEASE_COLORS['Rheumatoid Arthritis'],
    member_count: 156,
  },
  {
    id: 'g-cd',
    ...
    color: DISEASE_COLORS["Crohn's Disease"],
    member_count: 173,
  },
  {
    id: 'g-ms',
    ...
    color: DISEASE_COLORS['Multiple Sclerosis'],
    member_count: 201,
  },
]
